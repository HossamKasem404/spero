...
class GetAllSearchedTripsDetailes extends StatelessWidget {

  GetAllSearchedTripsDetailes({super.key,required this.tripdetails,});
 var tripdetails ;
      ...
      Padding(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Text('Seats Available: ${tripdetails.amountofpeople}'),
